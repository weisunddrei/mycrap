...
//        priceMax.click();
        ...
        select.click();
        Thread.sleep(7000);
//        WebElement select = driver.findElement(By.xpath("//*[@content-desc,'Добавить в избранное']"));
//        select.click();
//        Thread.sleep(7000);
        ...
        planShow.click();
        Thread.sleep(8000);
        WebElement search = driver.findElement(By.xpath("id:com.riesapp.debug:id/loader"));
        search.sendKeys("Крилл");
        Thread.sleep(7000);
